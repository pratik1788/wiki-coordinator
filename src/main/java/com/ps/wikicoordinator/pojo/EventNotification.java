...
public class EventNotification extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -6490535720433438670L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"EventNotification\",\"namespace\":\"com.ps.wikicoordinator.pojo\",\"fields\":[{\"name\":\"fileName\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"eventName\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"eventTimeStamp\",\"type\":{\"type\":\"long\",\"logicalType\":\"timestamp-millis\"}},{\"name\":\"details\",\"type\":[\"null\",{\"type\":\"string\",\"avro.java.string\":\"String\"}],\"default\":null}]}");
...
static {
   ...
   */
  public static com.ps.wikicoordinator.pojo.EventNotification.Builder newBuilder() {
    return new com.ps.wikicoordinator.pojo.EventNotification.Builder();
  }
   ...
   * @return A new EventNotification RecordBuilder
   */
  public static com.ps.wikicoordinator.pojo.EventNotification.Builder newBuilder(com.ps.wikicoordinator.pojo.EventNotification.Builder other) {
    if (other == null) {
      return new com.ps.wikicoordinator.pojo.EventNotification.Builder();
    } else {
      return new com.ps.wikicoordinator.pojo.EventNotification.Builder(other);
    }
  }
   ...
   * @return A new EventNotification RecordBuilder
   */
  public static com.ps.wikicoordinator.pojo.EventNotification.Builder newBuilder(com.ps.wikicoordinator.pojo.EventNotification other) {
    if (other == null) {
      return new com.ps.wikicoordinator.pojo.EventNotification.Builder();
    } else {
      return new com.ps.wikicoordinator.pojo.EventNotification.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<EventNotification>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.ps.wikicoordinator.pojo.EventNotification.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.ps.wikicoordinator.pojo.EventNotification other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.fileName)) {
        this.fileName = data().deepCopy(fields()[0].schema(), other.fileName);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ps.wikicoordinator.pojo.EventNotification.Builder setFileName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ps.wikicoordinator.pojo.EventNotification.Builder clearFileName() {
      fileName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ps.wikicoordinator.pojo.EventNotification.Builder setEventName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ps.wikicoordinator.pojo.EventNotification.Builder clearEventName() {
      eventName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ps.wikicoordinator.pojo.EventNotification.Builder setEventTimeStamp(java.time.Instant value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ps.wikicoordinator.pojo.EventNotification.Builder clearEventTimeStamp() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ps.wikicoordinator.pojo.EventNotification.Builder setDetails(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ps.wikicoordinator.pojo.EventNotification.Builder clearDetails() {
      details = null;
